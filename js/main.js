...
function calculateTimeSlots() {
    ...
    for (let i = 1; i <= total; i++) {
        ...
        currentMinutes += classLen; // 這裡現在是安全的數學加法囉！
...
// 變更時間引擎設定 (完全對應手動 key-in 的 input 欄位)
function updateTimeEngine() {
    // 這裡點 value 拿到的都是使用者在網頁格子裡自己手 key 的數值
